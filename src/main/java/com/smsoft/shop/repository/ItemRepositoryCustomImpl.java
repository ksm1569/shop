...
import com.smsoft.shop.dto.QMainItemDto;
import com.smsoft.shop.entity.Item;
import com.smsoft.shop.entity.QItem;
import com.smsoft.shop.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    public Page<Item> getAdminItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        QueryResults<Item> results = queryFactory.selectFrom(QItem.item).where(regDtsAfter(itemSearchDto.getSearchDateType()), searchSellStatusEq(itemSearchDto.getSearchSellStatus()), searchByLike(itemSearchDto.getSearchBy(), itemSearchDto.getSearchQuery())).orderBy(QItem.item.id.desc()).offset(pageable.getOffset()).limit(pageable.getPageSize()).fetchResults();
